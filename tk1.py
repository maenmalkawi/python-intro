...
class StartPage(tk.Frame):
	def __init__(self, parent, controller): 
		...
		style = ttk.Style() #we use this to edit style 
		style.configure("BW.TLabel",background="red")
		button1 = ttk.Button(self, text ="Page 1",style="BW.TLabel",
		...
		buttonQ = ttk.Button(self, text ="Exit",
		command = root.destroy())
	
		# putting the button in its place by
		# using grid
		buttonQ.grid(row = 4, column = 1, padx = 10, pady = 10)
